		...
		<div className={popup ? "settings--popup" : "settings--popupActive"}>
			...
			<div className="themes">
				...
				<ul className="themes--colors">
					<li
						className="themes--colorsIn green"
						onClick={() => setTheme("#41a169")}
					></li>
					<li
						className="themes--colorsIn blue"
						onClick={() => setTheme("#61aae5")}
					></li>
					<li
						className="themes--colorsIn purple"
						onClick={() => setTheme("#8269d5")}
					></li>
					<li
						className="themes--colorsIn red"
						onClick={() => setTheme("#e53e3e")}
					></li>
					<li
						className="themes--colorsIn orange"
						onClick={() => setTheme("#dc6c31")}
					></li>
					<li
						className="themes--colorsIn darkBlue"
						onClick={() => setTheme("#5b69d8")}
					></li>
					<li
						className="themes--colorsIn lightGreen"
						onClick={() => setTheme("#319795")}
					></li>
					<li
						className="themes--colorsIn gray"
						onClick={() => setTheme("#718096")}
					></li>
					<li
						className="themes--colorsIn yellow"
						onClick={() => setTheme("#d59e31")}
					></li>
				</ul>
			</div>
